...
print("""<div>	<button  type="button" onclick="location.href='mark_entry_regno.py'">Back</button>
...
list=[]
try:
	sql="UPDATE ENTRY SET sem=%s WHERE id=3" %(reg_no)
	cursor.execute(sql)
	db.commit()
except:
